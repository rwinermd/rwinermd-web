...
{{< rawhtml >}}
<img src="static/images/homepage/header-banner.jpg" alt="Academic credentials banner" style="width:100%;max-width:960px;display:block;margin:0 auto 1.5rem auto;">
{{< /rawhtml >}}
...
- Board-certified neurologist (Diplomate, American Board of Psychiatry and Neurology)
- Fellowship-trained psychopharmacologist
- University of Pennsylvania (Ivy League)
- National Hospital of Nervous Diseases, London
- Zentrum für Tiefenpsychologie, Zürich — Diplomate (FAZ)
...
If you leave a message, include the date and time you called, your name, phone number, and email address (please spell out your email slowly and repeat it).

**To schedule an appointment:**

- [Schedule a Second Opinion Consultation →](/schedule-second-opinion/)
- [Schedule for Psychoanalysis →](/schedule-psychoanalysis/)
